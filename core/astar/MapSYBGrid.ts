 ...
 *
 */
class MapSYBGrid extends egret.Sprite {
	/**
	 * @private
	 * 地图网格节点
	 */
	protected _nodes: MapGridSYBNode[][];
	...
	private _poolNodes:MapGridSYBNode[];
	 ...
	 */
	public getNode(x: number, y: number): MapGridSYBNode {
		if (this._nodes[x])
	 ...
	 * 这里可以使用对象池技术进行优化
	 */
	public initMapInfo(mapInfo: MapSYBInfo, turn: number): void {
	...
	protected getGridNode():MapGridSYBNode {
		return this._poolNodes.pop() || new MapGridSYBNode();
	}
