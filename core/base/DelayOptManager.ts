 ...
 */
class DelayOptManager extends BaseSYBClass {
	...
	public addDelayOptFunction1(thisObj: any, fun: Function, funPara?: any, funPara1?: any[]): void {
		this._delayOpts.push({ "fun": fun, "thisObj": thisObj, "funPara": funPara, "funPara1": funPara1 });
	}
	public clear(): void {
	...
	// public stop(): void {
	// 	TimerSYBManager.ins().remove(this.runCachedFun, this);
	// }
