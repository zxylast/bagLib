...
class DirSYBUtil {
	...
	public static get8DirBy2Point(p1: any, p2: any): number {
		//计算方向
		let angle: number = MathSYBUtils.getAngle(MathSYBUtils.getRadian2(p1.x, p1.y, p2.x, p2.y));
	 ...
	 * p2 结束点
	 */
	public static get2DirBy2Point(p1: any, p2: any): number {
	...
	public static getGridByDir(dir: number, pos: number = 1, p: { x: number, y: number } = {
		...
		return MathSYBUtils.getDirMove(angle, pos, p.x, p.y);
	}
}