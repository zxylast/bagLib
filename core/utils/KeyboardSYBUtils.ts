 ...
 * 键盘工具类
 */
class KeyboardSYBUtils extends BaseSYBClass {
	...
	public constructor() {
		...
		if (DeviceSYBUtils.IsHtml5 && LocationSYBProperty.isLocation) {
			let self:any = this;
	...
	public static ins():KeyboardSYBUtils{
		return super.ins() as KeyboardSYBUtils;
	}
	/**
	 * 添加KeyUp事件
	 * @param callback 回调函数
