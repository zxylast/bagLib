...
class FilterSYBUtil {
	...
	static get ARRAY_GRAY_FILTER() {
		return [FilterSYBUtil.grayFilter1];
	}
	//灰色滤镜
	static get ARRAY_GRAY_FILTER2() {
		return [FilterSYBUtil.grayFilter];
	}
	...
	static get ARRAY_GREEN_FILTER() {
		return [FilterSYBUtil.greenFilter1];
	}
	...
	static get ARRAY_BLUR_FILTER() {
		return [FilterSYBUtil.blurFilter];
	}
}