...
class UIAnimation {
	...
	public static setAnimation(eobj: egret.DisplayObject, aniType: number, others?: { time: number, func?: any, ease?: any }): void {
		...
		switch (className) {
			...
			case "eui.Rect":
				...
				break;
			case "BaseSYBComponent":
				obj = eobj as BaseSYBComponent;
				break;
			case "eui.TabBar":
		...
		exscaleX = exscaleX ? exscaleX : obj.scaleX;
		...
		eyscaleY = eyscaleY ? eyscaleY : obj.scaleY;
	...
	private static aniStartEUI(obj: any, dir: {
		...
		// //console.log("横向：" + dir.sxhro + "---（" + obj.horizontalCenter);
		// //console.log("纵向：" + dir.syver + "---（" + obj.verticalCenter);
		// //console.log("横向结束：" + dir.exhro);
		// //console.log("纵向结束：" + dir.eyver);
		// //console.log("横向初始x：" + dir.sx + "---（" + obj.x);
		// //console.log("纵向初始y：" + dir.sy + "---（" + obj.y);
		// //console.log("横向结束x：" + dir.ex);
		// //console.log("纵向结束y：" + dir.ey);
		// //console.log("底边初始：" + dir.sybot + "---（" + obj.bottom);
		// //console.log("顶边初始：" + dir.sytop + "---（" + obj.top);
		// //console.log("底边结束：" + dir.eybot );
		// //console.log("顶边结束：" + dir.eytop );
		// //console.log("左边初始：" + dir.sxleft + "---（" + obj.left);
		// //console.log("右边初始：" + dir.sxright + "---（" + obj.right);
		// //console.log("左边结束：" + dir.exleft );
		// //console.log("右边结束：" + dir.exright );
		// //console.log("scaleX初始：" + dir.sxscaleX + "---（" + obj.scaleX);
		// //console.log("scaleY初始：" + dir.syscaleY + "---（" + obj.scaleY);
